import neuromotionLogo from '../assets/neuromotion/neuromotion_logo.png'
import opblockLogo from '../assets/opblock/opblock_logo.png'
import EMGScreen from '../assets/EMGreader/EMGreader.jpg'
import quokkaLogo from '../assets/quokka/quokka_logo.jpg'
...
export const projectsData = [
    ...
    },
    {
        ...
        visible: true,
        tags: ["Java Script", "HTML", "Electroencephalogram (EEG)", "OpenBCI", "PyTorch", "Machine Learning", "Python"]
    },
    {
        id: 4,
        img: EMGScreen,
    ...
    },
    {
        ...
        visible: true,
        tags: ["Android Studio", "Java", "Arduino", "Hardware", "MNE"]
    }
];